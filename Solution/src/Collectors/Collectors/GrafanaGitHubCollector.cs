...
public class GrafanaGitHubCollector : IVersionCollector
{
    private readonly HttpClient _httpClient;
    public string ProductName => "Grafana";

    public GrafanaGitHubCollector(HttpClient httpClient)
    {
    ...
    {
        var response = await _httpClient.GetAsync("repos/grafana/grafana/releases");
