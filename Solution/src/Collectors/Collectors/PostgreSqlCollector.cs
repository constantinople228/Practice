...
public class PostgreSqlGitHubCollector : IVersionCollector
{
    private readonly HttpClient _httpClient;
    public string ProductName => "PostgreSQL";

    public PostgreSqlGitHubCollector(HttpClient httpClient)
    {
    ...
    {
        var response = await _httpClient.GetAsync("repos/postgres/postgres/releases");
