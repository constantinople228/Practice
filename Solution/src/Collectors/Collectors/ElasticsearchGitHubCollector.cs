...
public class ElasticsearchGitHubCollector : IVersionCollector
{
    private readonly HttpClient _httpClient;
    public string ProductName => "Elasticsearch";

    public ElasticsearchGitHubCollector(HttpClient httpClient)
    {
    ...
    {
        var response = await _httpClient.GetAsync("repos/elastic/elasticsearch/releases");
